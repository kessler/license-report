 ...
 */
export function getDependencies(packageJson, exclusions, inclusions, exclusionRegex) {
  let depsIndex = []
  const noDepsTypeDefined = isNullOrUndefined(inclusions) || !Array.isArray(inclusions) || (inclusions.length === 0)
